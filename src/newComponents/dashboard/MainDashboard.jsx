              ...
              {loadingAttendance ? (
                ...
                filteredData.map((item, idx) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-500">
                      In: {formatTime(item.clockIn)} | Out:{" "}
    ...
    <div className="p-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {role === "admin" && (
          <button
            onClick={() => navigate("/user-management")}
            className="flex flex-col items-center justify-center h-24 rounded-lg border-2 border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-200 transform hover:scale-105"
          >
